...
class TestPassesPortfolioGate:
    ...
    # The following test is commented out because it relies on the specific random data generated by the fixture,
    # which may not be stable across environments or future changes. It can be re-enabled if a more deterministic test signal is used.
